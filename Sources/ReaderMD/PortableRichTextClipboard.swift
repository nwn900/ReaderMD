...
/// nodes only work while ReaderMD's stylesheets and fonts are present, so apps
...
enum PortableRichTextClipboard {
    static let assetURLPrefix = "readermd-copy-asset:"
    ...
    static func htmlEmbeddingAssets(
        ...
        // ReaderMD URL behind: destinations would display a broken-image
        ...
        return result.replacingOccurrences(
            of: #"readermd-copy-asset:[A-Za-z0-9-]+"#,
            with: fallbackURL,
