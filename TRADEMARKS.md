...
This policy is intended to encourage forks, ports, reviews, tutorials, and
experiments while protecting users from confusing one build with another.
...
Permission to use a mark is separate from copyright in contributed code and can
be limited or withdrawn if the use becomes misleading.

## Questions

Open a GitHub discussion for ordinary naming questions. For a private or
commercial request, contact [Adam Jesionkiewicz](mailto:adam@jesion.pl).

This policy is not a waiver of any rights and may be clarified as the project
grows.
