...
final class WorkspaceLayoutTests: XCTestCase {
    ...
    func testSourceModeUsesWrappingSyntaxColoredEditor() throws {
        ...
        let sourceEditorURL = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/ReaderMD/MarkdownSourceEditor.swift")
        ...
        XCTAssertTrue(sourceEditor.contains("MarkdownSourceContainerView"))
        XCTAssertTrue(sourceEditor.contains("gutterRect(intersecting:"))
    ...
    private func workspaceSource() throws -> String {
        let url = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/ReaderMD/WorkspaceView.swift")
    ...
    private func readerMDAppSource() throws -> String {
        let url = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/ReaderMD/ReaderMDApp.swift")
