import Foundation
import Testing
@testable import PreviewMDQuickLook
...
struct QuickLookExtensionTests {
    ...
    @Test("Extension declares both PreviewMD and common Markdown UTIs")
    func supportedContentTypes() throws {
        ...
        #expect(types.contains("pl.jesion.previewmd.markdown"))
        ...
        let markdown = try #require(
            documentTypes.first { type in
                (type["LSItemContentTypes"] as? [String])?
                    .contains("pl.jesion.previewmd.markdown") == true
            }
        )
